...
public class IntersectingWeightedAdditivePotential extends
		IntersectingAdditivePotential {

	private final List<Map<PlainTransaction, Double>> transactionWeights;

	public IntersectingWeightedAdditivePotential(int cardinalityPos,
			int cardinalityNeg,
