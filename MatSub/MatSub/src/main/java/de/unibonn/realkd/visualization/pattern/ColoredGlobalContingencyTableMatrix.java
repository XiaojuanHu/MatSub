 ...
 *
 */
public class ColoredGlobalContingencyTableMatrix implements PatternVisualization {

	ColoredGlobalContingencyTableMatrix() {
		;
	}
	...
	public JFreeChart draw(Pattern<?> pattern) {
		...
		ContingencyTable localModel = (ContingencyTable) subgroup.referenceModel();
	...
	public JFreeChart drawDetailed(Pattern<?> pattern) {
		...
		return JFChartPainter.DETAILED.colorMatrix("Reference contingency table", firstAttribute.caption(), secondAttribute.caption(), values,
